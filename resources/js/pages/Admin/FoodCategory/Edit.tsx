...
import { index, store, update } from "@/routes/admin/food-categories"
...
export default function FoodCategoryEdit({ foodCategory }: FoodCategoryProps) {
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div className="space-y-2">
                                                ...
                                                <Input
                                                    ...
                                                    name="title"
                                                    type="text"
                                                    defaultValue={foodCategory.title}
                                                />
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <Input
                                                    ...
                                                    name="slug"
                                                    type="text"
                                                    defaultValue={foodCategory.slug}
                                                />
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                {foodCategory.image && (
                                                    <div className="mt-2">
                                                       <img src={foodCategory.image} alt="" className="w-24 h-24 rounded-md"  />
                                                    </div>
                                                )}
                                            </div>
