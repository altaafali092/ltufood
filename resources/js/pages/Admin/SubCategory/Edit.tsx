...
import { index, store, update } from "@/routes/admin/sub-categories"
...
export default function SubCategoryEdit({categories,subCategory}:categoryProps) {
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-4 ">
                ...
                <div className="w-full">
                    <Card>
                        ...
                        <CardContent>
                            <Form
                                action={update(subCategory.id).url}
                                method="post"
                                className="space-y-6"
